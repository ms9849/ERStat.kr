# ERStat.kr<br/>
개발 인원 : 1인<br/>
개발 환경 : Node.Js, Express, MySQL, Google Cloud Platform<br/>
개발 기간 : 2022.09 ~ 2022.10 (약 3주)


## 프로젝트 개요
2022년 10월 약 3주동안 서비스했던 Erstat 프로젝트입니다.

이터널 리턴의 공개 API를 활용하여 게임 데이터(수백만건 이상)들을 수집하고 통계 및 표본을 제공했었습니다. 그리고 제작한 사이트를 유저 커뮤니티에 공개하며, 피드백을 빠르게 수용하여 프로젝트를 디벨롭했습니다.

더욱 빠른 데이터 수집을 위해 여러 개의 키를 정해진 시간 단위로 스왑하는 라운드 로빈 기법을 구현하여 사용했었습니다. 

또한 실시간에 가까운 데이터 수집을 위해 많은 고민(유저 데이터 기반 GameID 탐색 후 데이터 갱신, 최신 GameID 탐색 방법 개선)을 했었으나, 결국 적용하지 못한 점은 프로젝트를 진행하며 아쉬운 점으로 남았습니다.
